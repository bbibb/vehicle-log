...
<div class="card-header py-3 text-center text-light m-5 my-3">
    <h1>Are you sure you want to delete User Record</h1>
</div>
<!-- The outer container keeps the two inner containers in sync viz. width -->
<div class="container px-5">
    <div class="container px-lg-3 py-0 bg-light">
        <!-- The form creates a POST array and sends to users.php -->
        <form action="delete_user_db.php" method="post"
              id="delete_user_form">
            <div class="row py-5 mx-5 justify-content-center">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input type="text readonly" class="form-control" id="user_id" value="<?php echo $user['user_id']; ?>" placeholder="UserID" name="user_id">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="username" value="<?php echo $user['user_name']; ?>" placeholder="Username" name="user_name">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="date" value="<?php echo date('m-d-Y', strtotime($user['date_created'])); ?>" placeholder="Enter date created" name="date_created">
                </div>
                ...
                <button type="submit" class="btn btn-primary" value="delete user">Confirm: Delete</button>
                <!--                </div>-->
            </div>
        </form>
