...
<!--    JavaScript table filter based on https://www.w3schools.com/howto/howto_js_filter_table.asp
-->
    <script src=
...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-success">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
                ...
                <li>
                    <div class="btn-nav"><a class="btn text-light" href="files.php">Images</a>
                    </div>
                </li>
                <li>
                    <div class="btn-nav"><a class="btn text-light" href="users.php">Users</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="navbar-collapse collapse ">
        <div class="btn-nav bg-secondary"><a href="profile.php" class="btn text-light"><?php echo $_SESSION['name'];?>:</a>
        </div>
