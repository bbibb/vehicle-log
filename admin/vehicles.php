...
<div class="container container-fluid px-lg-5 py-0">
    ...
    <table class="table table-striped table-bordered table-responsive table-bordered table-responsive bg-light" style="width:100%">
<thead>
    <tr>
        <th>Class</th>
        <th>Make</th>
    ...
    <tr>
        ...
        <td>
            <form action="delete_vehicle.php" method="post"
                ...
                <button type="submit" class="btn btn-outline-primary btn-sm" name="vehicle_VIN"
                        value="<?php echo $vehicle['vehicle_VIN'];?>">delete</button>
            </form>
        </td>
        <td>
            <form action="vehicle_report.php" method="post"
                  id="vehicle_report_form">
                <button type="submit" class="btn btn-outline-primary btn-sm" name="vehicle_VIN"
                        value="<?php echo $vehicle['vehicle_VIN'];?>">report</button>
            </form>
