...
<div class="card-header py-3 text-center text-light m-5 my-3">
    <h1>Are you sure you want to delete Maintenance Type?</h1>
</div>
...
<div class="container px-5">
    <div class="container px-lg-3 py-0 bg-light">
        ...
        <form action="delete_maintenance_type_db.php" method="post"
            ...
            <div class="row py-5 mx-5 justify-content-center">
                ...
                <div class="mb-3 mt-3">
                    ...
                    <input readonly type="text" class="form-control" id="maintenance_type" value="<?php echo $type['maintenance_type']; ?>" placeholder="Description" name="maintenance_type">
                </div>
                ...
                <button type="submit" class="btn btn-primary" value="edit maintenance type">Confirm: Delete</button>
                <!--                </div>-->
            </div>
        </form>
