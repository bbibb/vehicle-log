...
$query = 'SELECT * 
            ...
            LEFT JOIN maintenance_type on maintenance.maintenance_type_id 
...
<div class="container container-fluid w-auto px-lg-5 py-0">
...
<!--                <td>--><?php //echo $main['maintenance_id']; ?><!--</td>-->
                ...
                <td>
                    <form action="delete_maintenance.php" method="post"
                          id="delete_maintenance_form">
                        <button type="submit" class="btn btn-outline-primary btn-sm" name="maintenance_id"
                                value="<?php echo $main['maintenance_id'];?>">delete</button>
                    </form>
                </td>
            </tr>
        <?php endforeach; ?>
...
<script>
    $(document).ready(function () {
        $("#search").on("keyup", function () {
            ...
            $("#maintenance tr").filter(function () {
