...
<div class="card-header py-3 text-center text-light m-5 my-3">
    <h1>Are you sure you want to delete Fuel Record</h1>
</div>
...
<div class="container px-5">
    <div class="container px-lg-3 py-0 bg-light">
        ...
        <form action="delete_fuel_db.php" method="post"
              id="delete_fuel_form">
            ...
            <div class="row py-5 mx-5 justify-content-center">
                ...
                <div class="mb-3">
                    ...
                    <input readonly type="text" class="form-control" id="date" value="<?php echo date('m-d-Y', strtotime($fuel['fuel_date'])); ?>" placeholder="Enter date" name="fuel_date">
                </div>
                <div class="mb-3 mt-3">
                    <label for="vehicle" class="form-label">Vehicle ID:</label>
                    <input readonly type="text" class="form-control" id="vehicle" value="<?php echo $fuel['vehicle_id']; ?>" placeholder="Vehicle" name="vehicle_id">
                </div>
                <div class="mb-3">
                    <label for="source" class="form-label">Source:</label>
                    <input readonly type="text" class="form-control" id="source" value="<?php echo $fuel['fuel_source']; ?>" placeholder="Enter fuel source" name="fuel_source">
                </div>
                <div class="mb-3">
                    <label for="gallons" class="form-label">Gallons:</label>
                    <input readonly type="text" class="form-control" id="gallons" value="<?php echo $fuel['fuel_gallons']; ?>" placeholder="Enter gallons purchased" name="fuel_gallons">
                </div>
                <div class="mb-3">
                    <label for="cost" class="form-label">Cost:</label>
                    <input readonly type="text" class="form-control" id="cost" value="<?php echo $fuel['fuel_cost']; ?>" placeholder="Enter fuel cost per gallon" name="fuel_cost">
                </div>
                <div class="mb-3">
                    <label for="mileage" class="form-label">Mileage:</label>
                    <input readonly type="text" class="form-control" id="mileage" value="<?php echo $fuel['fuel_mileage']; ?>" placeholder="Enter mileage since last fill" name="fuel_mileage">
                </div>
