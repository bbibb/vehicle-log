...
<!--                    <input type="text" class="form-control" id="type_id" value="--><?php //echo $main['maintenance_type_id']; ?><!--" placeholder="Maintenance Type" name="maintenance_type_id">-->
<!--                </div>-->
<!--                <div class="mb-3 mt-3">-->
<!--                    <label for="vehicle" class="form-label">Vehicle ID:</label>-->
<!--                    <input type="text" class="form-control" id="vehicle" value="--><?php //echo $main['vehicle_id']; ?><!--" placeholder="Vehicle ID" name="vehicle_id" readonly>-->
<!--                </div>-->
                <div class="mb-3">
